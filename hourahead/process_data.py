...
# # 計算預測發電變化量target
# train_target = []
# for i in range(timesteps, len(train_target_raw)):
#     train_target.append(train_target_raw[i][0] - train_target_raw[i-1][0])
# train_target = np.array(train_target)

# test_target = []
# for i in range(timesteps, len(test_target_raw)):
#     test_target.append(test_target_raw[i][0] - test_target_raw[i-1][0])
